...
function ChefSpecialMenu() {
  ...
  const fetchFoodItems = (cityName) => {
    ...
    fetch(
      `http://localhost:5000/api/food-items/chef_special?city=${encodeURIComponent(
        cityName
      )}`
    )
      .then((res) => res.json())
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {/* Modal */}
      {modalData && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50 p-4 font-lato" style={{ fontFamily: "'Lato', sans-serif" }}>
            ...
            <div className="md:w-3/5 w-full p-8 flex flex-col justify-between">
              <div>
                ...
                <p className="mt-6 text-indigo-700 font-light text-2xl">
                  <span className="font-semibold">Total Price:</span> ₹{modalData.price}
                </p>
